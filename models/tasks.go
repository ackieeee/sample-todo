...
var TaskWhere = struct {
	...
	Date:        whereHelpernull_Time{field: "`tasks`.`date`"},
	Status:      whereHelperbool{field: "`tasks`.`status`"},
}
...
var (
	taskAllColumns            = []string{"id", "title", "description", "date", "status"}
	taskColumnsWithoutDefault = []string{"title", "description"}
	taskColumnsWithDefault    = []string{"id", "date", "status"}
